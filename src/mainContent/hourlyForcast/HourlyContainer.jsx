...
const HourlyContainer = ({hourlyWhether,isPending}) => {
  ...
  return (
    <section className="w-full md:w-88 sm:w-80 pb-3 flex flex-col gap-4 bg-neutral-800 rounded-2xl mt-7 md:m-0" aria-labelledby="hourly-header">
      ...
      <div className="w-full flex flex-col gap-4 h-128 overflow-y-auto px-4">
