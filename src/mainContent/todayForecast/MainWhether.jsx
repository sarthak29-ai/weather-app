...
const MainWhether = ({isPending, temperature,location,date,code}) => {
  ...
  if (isPending){
    ...
    return(
      <article className="w-full h-auto flex flex-col items-center justify-center gap-4 bg-[url('/weather-app/images/bg-today-small.svg')] sm:bg-[url('/weather-app/images/bg-today-large.svg')] bg-contain aspect-[1.2] sm:aspect-[2.79] bg-no-repeat mb-4 rounded-2xl sm:rounded-3xl overflow-hidden sm:p-4 sm:flex-row sm:justify-between sm:items-center">
